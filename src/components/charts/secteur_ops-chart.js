...
const formatData = (data, nom, date) => {
  ...
  datasets.push({
    label: "Crise",
    type: "line",
    borderColor: colors.seuil_crise,
    backgroundColor: "rgba(0,0,0,0)",
    pointBorderColor: colors.seuil_crise,
    pointBackgroundColor: "#eceff1",
    pointHoverBackgroundColor: colors.seuil_crise,
    pointHoverBorderColor: colors.seuil_crise,
    yAxisID: "y-axis-2",
    order: 1,
    data: sortTableau.map(f => Number(f.properties.seuil_crise))
  });
...
const SecteurOpsChart = ({ brutData, nom, date, maxValue }) => (
  <div
    style={{
      position: "relative",
      margin: " auto",
...
export default SecteurOpsChart;
